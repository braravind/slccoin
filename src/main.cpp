...
uint256 hashGenesisBlock("0x7206e76c6e3b0d988dfc94fd6bc12d784e924fa29bc8a7a6cf15415e689ec583");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Slc: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Slc Signed Message:\n";
...
{
    // Slc: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 302400; // Slc: 3.5 days
static const int64 nTargetSpacing = 150; // Slc: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Slc: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Slc: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Slc: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc24f567e81ca16dcea7d76f36ffb33c8eef9170a92ff00e6799b44fe203063dc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ce70443538e9f64eb08c4a5207794698b0d7ca48b5ca62d64018525820f5f9e7a72011056c5a3ebf2e1c68744f00a22be7a5ca45482e7000d998e55b9e0bc8bc0e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1525690029;
        block.nBits    = 504365644;
        block.nNonce   = 955748454;

        if (fTestNet)
        {
            block.nTime    = 1525690029;
            block.nNonce   = 3215251734;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x645c37b6167fb1353e5fab4b2ab40cc37e0d037654ca86ba5a21e93a66bc3370"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Slc: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SlcMiner : ProcessBlock, block not accepted");
    }
